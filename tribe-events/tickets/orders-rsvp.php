...
<!-- GUIDE -->
<!-- <small class="page_guide"> tickets > orders-rsvp.php </small> -->

<div class="tribe-rsvp">

	<!-- My RSVPs for This Event -->
	<!-- <small class="page_guide"> tickets > orders-rsvp > title </small> -->
	<div class="event--attendee">
		<h2>
			<?php printf( esc_html__( 'My RSVPs for This %s', 'event-tickets' ), $post_type->labels->singular_name ); ?>
		</h2>
		...
		<div class="user-details">
			...
			<!-- <small class="page_guide"> tickets > orders-rsvp > subtitle </small> -->
			<p>
				<?php
				printf(
	...
	<div class="event--attendee">
		<!-- Attendee box -->
		<!-- <small class="page_guide"> tickets > orders-rsvp > attendee box </small> -->
		...
		<ul class="tribe-rsvp-list tribe-list">
			...
			<li class="tribe-item<?php echo $view->is_rsvp_restricted( $post_id, $attendee['product_id'] ) ? 'tribe-disabled' : ''; ?>" <?php echo $view->get_restriction_attr( $post_id, $attendee['product_id'] ); ?> id="attendee-<?php echo $attendee['order_id']; ?>">
				...
				<!-- <small class="page_guide"> tickets > orders-rsvp > attendee title </small> -->
				...
				<div class="tribe-answer">
					...
					<!-- <small class="page_guide"> tickets > orders-rsvp > status </small> -->
					<label>
					...
					<!-- <small class="page_guide"> tickets > orders-rsvp > type </small> -->
